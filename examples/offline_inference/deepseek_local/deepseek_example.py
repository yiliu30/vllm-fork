...
parser.add_argument("--fp8_inc", action="store_true", help="fp8_inc")
parser.add_argument("--weights_load_device_cpu", action="store_true", help="weights_load_device_cpu")
...
if __name__ == "__main__":
    ...
    if args.weights_load_device_cpu:
        param["weights_load_device"] = "cpu"
    if args.ep_size > 1:
