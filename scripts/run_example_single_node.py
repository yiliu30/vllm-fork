...
parser.add_argument(
    "--tp_size", type=int, default=1, help="The number of threads."
)
...
parser.add_argument(
    "--osl", type=int, default=1024, help="output sequence length."
)
parser.add_argument(
...
parser.add_argument(
    "--fp8_kv_cache", action="store_true", help="Use fp8 for kv cache."
)
parser.add_argument(
    "--enforce_eager", action="store_true", help="Enforce eager"
)
parser.add_argument("--inc", action="store_true", help="Quantization with INC")
...
if __name__ == "__main__":
    ...
    if args.dataset == "sonnet":
        ...
        print(
            f"Got {len(prompts)} prompts, length of first prompt: {len(prompt_token_ids[0])}."
        )
        gt = None
    else:
        prompts = [
