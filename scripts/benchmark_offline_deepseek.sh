...
python3 ../benchmarks/benchmark_throughput.py \
    ...
    --gpu-memory-util 0.95 2>&1 | tee inc_quant_logs/ben-offline-throughput-${model_name}-mtp-nocontpa-bs${bs}-in${in_len}-out${out_len}-tp${tp_parallel}-${log_postfix}.log
