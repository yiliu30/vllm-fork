...
config_list=(
  "8192,2048,2048,48,16,2,4,gloo,auto,[32,29]"
)

KV=auto

config_list=(
  "8192,2048,64,3,1,2,4,hccl,${KV},[32,29]"
  "8192,2048,64,3,1,2,4,hccl,${KV},[32,29]"
  "8192,2048,64,6,2,2,4,hccl,${KV},[32,29]"
  "8192,2048,64,6,2,2,4,hccl,${KV},[32,29]"
  "8192,2048,64,12,4,2,4,hccl,${KV},[32,29]"
  "8192,2048,64,12,4,2,4,hccl,${KV},[32,29]"
  "8192,2048,2048,3,1,2,4,hccl,${KV},[32,29]"
  "8192,2048,2048,3,1,2,4,hccl,${KV},[32,29]"
  "8192,2048,2048,6,2,2,4,hccl,${KV},[32,29]"
  "8192,2048,2048,6,2,2,4,hccl,${KV},[32,29]"
  "8192,2048,2048,12,4,2,4,hccl,${KV},[32,29]"
  "8192,2048,2048,12,4,2,4,hccl,${KV},[32,29]"
)
