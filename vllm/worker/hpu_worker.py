...
class HPUWorker(LocalOrDistributedWorkerBase):
    ...
    def determine_num_available_blocks(self) -> Tuple[int, int]:
        ...
        # FIXME: (Yi) WA for run lm-eval, add back
        ...
        num_cpu_blocks = int(self.cache_config.swap_space_bytes //
                             cache_block_size)
        num_hpu_blocks = int( max(num_hpu_blocks, 0) * 0.5)
        num_cpu_blocks = int(max(num_cpu_blocks, 0) * 0.5)
    ...
    def initialize_cache(self, num_gpu_blocks: int,
        ...
        self.model_runner.bucketing_ctx.num_hpu_blocks = num_gpu_blocks
