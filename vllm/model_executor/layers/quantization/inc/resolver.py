...
class INCConfigResolver:
    ...
    def _resolve_raw(
        ...
        prefixed_layer_name = f"model.{layer_name}"
        if self._config.extra_config and prefixed_layer_name in self._config.extra_config:
            return get_config(prefixed_layer_name)
