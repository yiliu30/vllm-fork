...
class OCP_MX_Scheme(str, Enum):
    ...
    w_mxfp8_e4m3_a_mxfp8_e4m3_from_mxfp4 = "w_mxfp8_e4m3_a_mxfp8_e4m3_from_mxfp4"
    ...
    def from_quant_dtype(
        ...
        if input_dtype not in OCP_MX_DTYPES or weight_dtype not in OCP_MX_DTYPES:
            ...
            and weight_dtype == "mxfp8_e4m3"
            and original_dtype == "mxfp4"
        ):
            return cls.w_mxfp8_e4m3_a_mxfp8_e4m3_from_mxfp4
