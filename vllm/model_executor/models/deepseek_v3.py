...
class DeepseekV3DecoderLayer(nn.Module):
    ...
    def forward(
        ...
        show_mem_info(logger, f"layer {self._layer_idx}: before self_attn")
        ...
        show_mem_info(logger, f"layer {self._layer_idx}: after self_attn")
        ...
        show_mem_info(logger, f"layer {self._layer_idx}: after mlp")
